...
from SAM.SAM_Drivers import SAMDriver_speech_old
...
mySAMpy = SAMDriver_speech_old(False, delta=delta, context=context, n_mixtures=n_mixtures)
...
print('Loading model ..')
cur = SAMDriver_speech_old(False, delta=delta, context=context, n_mixtures=n_mixtures)
cur.Quser=4
